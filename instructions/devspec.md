...
4. **Follow the canonical implementation contract.** `claim_work_item` returns the current contract for implementation, evidence, commits, pushing, and lifecycle. Follow that served contract rather than restating mutable rules here.
